...
from po.pkg.moead.tests.test_util import default_dominating_individual, default_individual, \
...
class IndividualTest(unittest.TestCase):
    ...
    def test_str(self):
        self.assertEqual(
            "{'variables': {'0': 2, '1': 1, '2': 2}, 'constraints': ['constraint', 'constraint'], 'objectives': [2, 1, 2]}",
